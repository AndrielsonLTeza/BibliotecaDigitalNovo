        ...
        public async Task<IEnumerable<GenreDTO>> GetAllGenresAsync()
{
    ...
    var genreDTOs = genres.Select(g => new GenreDTO
    {
        ...
        Books = g.Books?.Select(b => new BookDTO
        {
            ...
            ISBN = b.ISBN,
            GenreId = g.Id, // Atribuindo o ID do gênero
            GenreName = g.Name // Atribuindo o nome do gênero
        }).ToList() ?? new List<BookDTO>() // Garantindo que Books não seja nulo
    ...
    public async Task<GenreDTO> GetGenreByIdAsync(int id)
    {
        ...
        return new GenreDTO
        {
            Id = genre.Id, // Garantindo que o ID seja atribuído
            Name = genre.Name,
            ...
            Books = genre.Books?.Select(b => new BookDTO
            {
                ...
                PublishedYear = b.PublishedYear,
                ISBN = b.ISBN,
                GenreId = genre.Id, // Atribuindo o ID do gênero
                GenreName = genre.Name // Atribuindo o nome do gênero
            }).ToList() ?? new List<BookDTO>() // Garantindo que Books não seja nulo
        };
    }
    ...
    public async Task<GenreDTO> CreateGenreAsync(CreateGenreDTO genreDto)
    {
        ...
        return new GenreDTO
        {
            ...
            Books = new List<BookDTO>() // Inicializando Books como uma lista vazia
        };
    }
